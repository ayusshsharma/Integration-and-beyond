	...
	<div class="content-wrapper">
		...
		<div class="content-area">
			...
			<?php else : ?>
				...
				<div class="post-card">
					<h2><?php esc_html_e( 'No posts found', 'ayush-integration-lab' ); ?></h2>
					<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'ayush-integration-lab' ); ?></p>
					<?php get_search_form(); ?>
				</div>
